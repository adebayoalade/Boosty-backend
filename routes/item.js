...
// Get recommendations based on total wattage
router.post("/recommend", async (req, res) => {
  try {
    ...
    const recommendations = generateRecommendations(totalWattage, totalDayHours, totalNightHours);
...
const generateRecommendations = (totalWattage, totalDayHours, totalNightHours) => {
